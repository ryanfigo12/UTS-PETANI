        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="/penjual" class="small-box-footer">click <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="/penarikan" class="small-box-footer">click <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
                        @endsection